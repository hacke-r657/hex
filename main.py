...
AmbientLight(color=color.rgba(140, 145, 165, 0.55))
...
def create_tree(x, z, scale=1):
    trunk = Entity(model='cube', position=(x, 1.3 * scale, z), scale=(0.45 * scale, 2.6 * scale, 0.45 * scale), color=color.rgb(97, 62, 34), collider='box')
    Entity(model='sphere', position=(x, 2.8 * scale, z), scale=(1.8 * scale, 1.5 * scale, 1.8 * scale), color=color.rgb(40, 110, 55))
    Entity(model='sphere', position=(x + 0.8 * scale, 2.6 * scale, z + 0.2 * scale), scale=(1.3 * scale, 1.1 * scale, 1.3 * scale), color=color.rgb(52, 130, 62))
    Entity(model='sphere', position=(x - 0.6 * scale, 2.5 * scale, z - 0.3 * scale), scale=(1.2 * scale, 1.2 * scale, 1.2 * scale), color=color.rgb(32, 95, 50))
    return trunk
...
# Camp and fire
camp = Entity(model='cube', position=(0, 1.5, 12), scale=(4, 3, 4), color=color.rgb(60, 70, 80), collider='box')
fire = Entity(model='sphere', position=(0, 2.1, 12), scale=(1.3, 1.3, 1.3), color=color.rgb(255, 120, 50))
